...
class ReserveServiceTest {
        ...
        @BeforeEach
        void setUp() {
                testReserve = new Reserve("Pedro", "LabIco", LocalDateTime.now(), LocalDateTime.now().plusHours(2),
                                "Pending",
                                false, "Study", "None");
                ...
                overlappingReserve = new Reserve("Maria", "LabIco", LocalDateTime.now().plusMinutes(30),
                                LocalDateTime.now().plusHours(2).plusMinutes(30), "Confirmed", true, "Research",
                                "Weekly");
        ...
        void testIsReserveDuplicate_SameTime() {
                when(reserveRepository.findByClassroomIdAndStartDate(testReserve.getClassroomId(),
        ...
        void testCreateReserve_DuplicateExists() {
                Reserve duplicateReserve = new Reserve("Maria", "LabIco", LocalDateTime.now(),
